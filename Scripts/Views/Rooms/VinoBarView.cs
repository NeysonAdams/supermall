...
public class VinoBarView : RoomView
{
    [SerializeField]
    private float put_time = 240;
    Vector3[] position = {
        new Vector3(-1.92f, 0, -1.83f),
        new Vector3(-1.92f, 0, -1.03f),

        new Vector3(-1.92f, 0, 1.23f),
        new Vector3(-1.92f, 0, 1.99f),
        new Vector3(-1.92f, 0, 2.74f),
