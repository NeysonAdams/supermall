...
public class CoffeShopView : RoomView
{
    [SerializeField]
    private float put_time = 180;
   
    Vector3[] position = {
        new Vector3(3.4f, 0.17f, 0.05f),
        new Vector3(3.4f, 0.17f, -0.55f),
        new Vector3(3.4f, 0.17f, -1.2f),

        new Vector3(1.7f, -0.15f, -1f),
        new Vector3(1.7f, -0.15f, 0f),
        new Vector3(1.7f, -0.15f, 1f),
        new Vector3(-0.3f, -0.15f, -1f),
        new Vector3(-0.3f, -0.15f, 0f),
        new Vector3(-0.3f, -0.15f, 1f),
        new Vector3(-2.3f, 0, -1f),
        new Vector3(-2.3f, 0, 0f),
        new Vector3(-2.3f, 0, 1f),

        new Vector3(2.3f, -0.15f, -1f),
        new Vector3(2.3f, -0.15f, 0f),
        new Vector3(2.3f, -0.15f, 1f),
        new Vector3(0.3f, -0.15f, -1f),
        new Vector3(0.3f, -0.15f, 0f),
        new Vector3(0.3f, -0.15f, 1f),
        new Vector3(-1.7f, 0, -1f),
        new Vector3(-1.7f, 0, 0f),
        new Vector3(-1.7f, 0, 1f),
    };
